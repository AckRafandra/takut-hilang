...
CREATE TABLE `menangani` (
  ...
  PRIMARY KEY (`id_petugas`,`id_bencana`),
  KEY `id_bencana` (`id_bencana`),
  CONSTRAINT `menangani_ibfk_1` FOREIGN KEY (`id_petugas`) REFERENCES `petugas` (`id_petugas`),
  CONSTRAINT `menangani_ibfk_2` FOREIGN KEY (`id_bencana`) REFERENCES `bencana` (`id_bencana`)
